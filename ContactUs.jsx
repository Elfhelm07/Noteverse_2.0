...
const ContactUs = () => (
  <div>
    <section id="contact-us" className="flex flex-row justify-between items-center py-12 px-20 bg-black text-[#8C52FF]">
      ...
      <div className="flex-1 pr-16">
        <h2 className="mb-4 text-3xl font-bold transition-transform duration-300 transform hover:scale-105">Contact Us</h2>
        <h3 className="mb-2">Phone</h3>
        <p className="text-white mb-5 transition-opacity duration-300 hover:opacity-80">+1 123-456-7890</p>
        <h3 className="mb-2">Email</h3>
        <p className="text-white mb-5 transition-opacity duration-300 hover:opacity-80">info@example.com</p>
        <h3 className="mb-2">Social</h3>
        <div className="flex items-center space-x-10">
          <img src={socialMedia1} alt="Social Media 1" className="w-8 h-8 transition-transform duration-300 transform hover:scale-125" />
          <img src={socialMedia2} alt="Social Media 2" className="w-8 h-8 transition-transform duration-300 transform hover:scale-125" />
          <img src={cameraImage} alt="Camera" className="w-8 h-8 transition-transform duration-300 transform hover:scale-125" />
        </div>
      </div>
    </section>

    <footer className="bg-[#8C52FF] text-white py-6 mt-12">
      <div className="max-w-screen-xl mx-auto flex justify-between items-center px-5">
        ...
        <div className="transition-transform duration-300 transform hover:scale-105">
          ...
          <div className="flex">
            ...
            <img src={cameraImage} alt="Camera" className="w-8 h-8 mr-2 transition-transform duration-300 transform hover:scale-125" />
          </div>
        </div>
      </div>
      <div className="text-center text-sm mt-4 transition-opacity duration-300 hover:opacity-80">
